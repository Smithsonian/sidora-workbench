/**
Paging plug-in for DataTables -- Adapted for Sidora by RA - 3/12/15
 */
(function($){
$.fn.dataTableExt.oPagination.input = {
	"fnInit": function ( oSettings, nPaging, fnCallbackDraw )
	{
		...
		nInput.className = "paginate_input form-text"; // added drupal form field class form-text to the input field
	...
	/* commented to disable pages loading on each keypress in the input field  */
	/*
